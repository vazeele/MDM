...
{
    class HREmpNonCashBenefitModel
    {
        ObservableCollection<HR_EMP_NONCASH_BENEFIT> LastBenefitInformation; //These will be shown in the datagrid
        ...
        void dgv_EmpNonCashBenefit_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
            if (!Attribute.IsDefined(typeof(HR_EMP_NONCASH_BENEFIT).GetProperty(e.PropertyName), typeof(DataMemberAttribute)))
                e.Cancel = true;
        ...
        void dgv_EmpNonCashbenefit_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        void EmpNonCashBenefitGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

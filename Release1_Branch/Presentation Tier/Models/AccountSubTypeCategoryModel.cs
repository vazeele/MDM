...
{
    class AccountSubTypeCategoryModel
    {
        ObservableCollection<FIN_AccountSubTypeCategory> LastAccountInformation; //These will be shown in the datagrid
        Accounts account; //Reference to Transaction Interface
        FIN_AccountSubTypeCategory EditingAccountInfo; //Stores what we're editing right now, Incase we need to cancel the edit
        public AccountSubTypeCategoryModel(Accounts account)
        {
            ...
            account.AccountSubTypeCatSearchControl.ResultsGrid.SelectionChanged += dgv_AccountSubTypeCat_SelectionChanged;
        ...
        void dgv_AccountSubTypeCat_AutoGeneratingColumn(object sender, DataGridAutoGeneratingColumnEventArgs e)
        {
            if (!Attribute.IsDefined(typeof(FIN_AccountSubTypeCategory).GetProperty(e.PropertyName), typeof(DataMemberAttribute)))
                e.Cancel = true;
        ...
        void dgv_AccountSubTypeCat_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        void AccountSubTypeCatGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

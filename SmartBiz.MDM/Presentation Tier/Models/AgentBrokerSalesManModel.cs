...
{
    internal class AgentBrokerSalesManModel
    {
        private ObservableCollection<ERP_AgentBrokerSalesMan> AgentBrokerSalesManInformation; //These will be shown in the datagrid
        private AgentBrokerSalesMan agentbrokersalesman; //Reference to AgentBrokerSalesMan Interface
        private ERP_AgentBrokerSalesMan EditingAgentBrokerSalesMan; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public AgentBrokerSalesManModel(AgentBrokerSalesMan agentbrokersalesman)
        {
            ...
            agentbrokersalesman.GLADropDown.Search = GeneralLedgerAccountModel.Search;
            agentbrokersalesman.CCDropDown.Search = CurrencyModel.Search;

            
            agentbrokersalesman.ABSMSearchControl.ResultsGrid.SelectedCellsChanged += dgv_AgentBrokerSalesMan_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (AgentBrokerSalesManInformation.Count > 0)
            {
                EditingAgentBrokerSalesMan = AgentBrokerSalesManInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_AgentBrokerSalesMan_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void AgentBrokerSalesManGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {
        ...
        {   //Get an instance of the service using Helper class
            ...
            {   //Get the current object in the EditGrid
                ...
                agentbrokersalesman.cmb_AgentBrokerSalesManFlag.GetBindingExpression(CustomSearchDropDown.CustomSelectedItemProperty).UpdateSource();
                ...
                {
                    if (!client.AgentBrokerSalesManExists(AgentBrokerSalesManToSave))
                    {
                        ApiAck ack = client.CreateAgentBrokerSalesMan(AgentBrokerSalesManToSave);

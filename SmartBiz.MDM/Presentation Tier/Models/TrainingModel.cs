...
namespace SmartBiz.MDM.Presentation
{
    ...
    {
        private ObservableCollection<HR_EMP_TRAININGS> TrainingInformation; //These will be shown in the datagrid
        private Training Training; //Reference to Transaction Interface
        private HR_EMP_TRAININGS EditingTrainingInfomation; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public TrainingModel(Training Training)
        {
            ...
            Training.TrainingSearchControl.ResultsGrid.SelectedCellsChanged += dgv_Training_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (TrainingInformation.Count>0)
            {
                EditingTrainingInfomation = TrainingInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_Training_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {

...
{
    internal class CostCenterModel
    {
        private ObservableCollection<FIN_CostCenter> CostCenterInformation; //These will be shown in the datagrid
        ...
        private void dgv_CostCenter_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void CostCenterGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

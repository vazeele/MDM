...
{
    internal class EmployeeJSModel
    {
        private ObservableCollection<HR_EMPLOYEE_JS> EmployeeJSInformation; //These will be shown in the datagrid
        private Employee employeejs; //Reference to Transaction Interface
        private HR_EMPLOYEE_JS EditingEmployeeJS; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public EmployeeJSModel(Employee employeejs)
        {
            ...
            employeejs.JSSearchControl.ResultsGrid.SelectedCellsChanged += dgv_EmployeeJS_SelectionChanged;
        ...
        private void dgv_EmployeeJS_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void EmployeeJSGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

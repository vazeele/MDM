...
namespace SmartBiz.MDM.Presentation
{
    ...
    {
        private ObservableCollection<FIN_Bank> Banks; //These will be shown in the datagrid
        private Bank bank; //Reference to Transaction Interface
        private FIN_Bank EditingBank; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public BankModel(Bank bank)
        {
            ...
            bank.BankSearchControl.ResultsGrid.SelectedCellsChanged += SearchControl_SelectionChanged;

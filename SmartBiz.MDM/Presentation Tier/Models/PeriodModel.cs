...
{
    internal class PeriodModel
    {
        private ObservableCollection<ERP_Period> PeriodInformation; //These will be shown in the datagrid
        private Production Production; //Reference to Transaction Interface
        private ERP_Period EditingPeriodInfomation; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public PeriodModel(Production Production)
        {
            ...
            Production.PeriodSearchControl.ResultsGrid.SelectedCellsChanged += dgv_Period_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            {
                EditingPeriodInfomation = PeriodInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_Period_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void PeriodGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

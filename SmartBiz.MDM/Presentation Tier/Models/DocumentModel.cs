...
namespace SmartBiz.MDM.Presentation
{
    ...
    {
        private ObservableCollection<ERP_Document> DocumentInformation; //These will be shown in the datagrid
        private Document document; //Reference to Transaction Interface
        private ERP_Document EditingDocument; //Stores what we're editing right now, Incase we need to cancel the edit

        public DocumentModel(Document document)
        {
            this.document = document;
            document.DSearchControl.Search = Search;
            document.DSearchControl.ResultsGrid.SelectedCellsChanged += dgv_Document_SelectionChanged;
        ...
        private void DocumentGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

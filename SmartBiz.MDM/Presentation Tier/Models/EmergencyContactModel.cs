...
{
    internal class EmergencyContactModel
    {
        private ObservableCollection<HR_EMP_EMERGENCY> EmergencyContactInformation; //These will be shown in the datagrid
        private EmergencyContact EmergencyContact; //Reference to Transaction Interface
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (EmergencyContactInformation.Count>0)
            {
                EditingEmergencyContactInfomation = EmergencyContactInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_EmergencyContact_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {

...
namespace SmartBiz.MDM.Presentation
{
    ...
    {
        private ObservableCollection<HR_EMPLOYEE> EmployeeInformation; //These will be shown in the datagrid
        private Employee employee; //Reference to Transaction Interface
        private HR_EMPLOYEE EditingEmployee; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public EmployeeModel(Employee employee)
        {
            ...
            employee.ESearchControl.ResultsGrid.SelectedCellsChanged += dgv_Employee_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            {
                EditingEmployee = EmployeeInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_Employee_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void EmployeeGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

...
{
    internal class HRWorkExperienceModel
    {
        private ObservableCollection<HR_EMP_WORK_EXPERIENCE> HRWorkExperiences; //These will be shown in the datagrid
        private HREmployeeWorkExperience HREmployeeWorkExperienceUI; //Reference to Transaction Interface
        private HR_EMP_WORK_EXPERIENCE EditingHRWorkExperience; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public HRWorkExperienceModel(HREmployeeWorkExperience HREmployeeWorkExperienceUI)
        {
            ...
            HREmployeeWorkExperienceUI.EMPWORKSearchControl.ResultsGrid.SelectedCellsChanged += dgv_LastTransactionInfo_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (HRWorkExperiences.Count>0)
            {
                EditingHRWorkExperience = HRWorkExperiences[0].Clone();
            }
        }
        ...
        private void EMPWORKGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

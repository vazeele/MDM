...
{
    internal class TransactionReferenceModel
    {
        private ObservableCollection<FIN_TxnReference> TransactionReferences; //These will be shown in the datagrid
        private Transaction transaction; //Reference to Transaction Interface
        private FIN_TxnReference EditingTransactionReference; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public TransactionReferenceModel(Transaction transaction)
        {
            ...
            transaction.TRSearchControl.ResultsGrid.SelectedCellsChanged += SearchControl_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (TransactionReferences.Count>0)
            {
                EditingTransactionReference = TransactionReferences[0].Clone();
            }
        }

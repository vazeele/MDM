...
{
    internal class DocumentAttributesModel
    {
        private ObservableCollection<ERP_DocumentAttributes> DocumentAttributesInformation; //These will be shown in the datagrid
        private Document document; //Reference to Transaction Interface
        private ERP_DocumentAttributes EditingDocumentAttributes; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public DocumentAttributesModel(Document document)
        {
            ...
            document.DASearchControl.ResultsGrid.SelectedCellsChanged += dgv_DocumentAttributesModel_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            if (DocumentAttributesInformation.Count>0)
            {
                EditingDocumentAttributes = DocumentAttributesInformation[0].Clone();
            }
        }

        //When the user selects a row in the datagrid
        private void dgv_DocumentAttributesModel_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void DocumentAttributesGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

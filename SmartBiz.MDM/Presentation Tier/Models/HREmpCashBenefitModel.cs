...
{
    internal class HREmpCashBenefitModel
    {
        private ObservableCollection<HR_EMP_CASH_BENEFIT> LastBenefitInformation; //These will be shown in the datagrid
        private HRBenefits benefit; //Reference to HR Benefit Interface
        private HR_EMP_CASH_BENEFIT EditingLastBenefitInfo; //Stores what we're editing right now, in case we need to cancel the edit
        ...
        public HREmpCashBenefitModel(HRBenefits benefit)
        {
            ...
            benefit.EmpCashBenefitSearchControl.ResultsGrid.SelectedCellsChanged += dgv_EmpCashbenefit_SelectionChanged;
        ...
        private void dgv_EmpCashbenefit_SelectionChanged(object sender, SelectedCellsChangedEventArgs e)
        {
        ...
        private void EmpCashBenefitGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

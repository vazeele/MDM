...
{
    internal class BankBranchModel
    {
        private ObservableCollection<FIN_BankBranch> BankBranches; //These will be shown in the datagrid
        private Bank bank; //Reference to Transaction Interface
        private FIN_BankBranch EditingBankBranch; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public BankBranchModel(Bank bank)
        {
            ...
            bank.BankBranchSearchControl.ResultsGrid.SelectedCellsChanged += SearchControl_SelectionChanged;
        ...
        private void ItemSourceChanged(object sender, EventArgs e)
        {
            ...
            {
                EditingBankBranch = BankBranches[0].Clone();
            }
        }

...
{
    internal class FixedTxnAttributesModel
    {
        private ObservableCollection<ERP_FixedTxnAttributes> FixedTxnAttributes; //These will be shown in the datagrid
        private Transaction transaction; //Reference to Transaction Interface
        private ERP_FixedTxnAttributes EditingFixedTxnAttribute; //Stores what we're editing right now, Incase we need to cancel the edit
        ...
        public FixedTxnAttributesModel(Transaction transaction)
        {
            ...
            transaction.FTASearchControl.ResultsGrid.SelectedCellsChanged += dgv_FixedTxnAttributes_SelectionChanged;
        ...
        private void FixedTransactionAttribGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

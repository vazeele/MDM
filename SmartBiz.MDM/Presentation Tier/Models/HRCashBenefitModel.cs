...
{
    internal class HRCashBenefitModel
    {
        private ObservableCollection<HR_CASH_BENEFIT> LastBenefitInformation; //These will be shown in the datagrid
        private HRBenefits benefit; //Reference to Account Interface
        ...
        private void CashBenefitGrid_SourceUpdated(object sender, DataTransferEventArgs e)
        {

...
namespace SmartBiz.MDMAPI.Common.Entities
{
    ...
    public partial class ERP_SubModule
    {
    	[DataMember]
    	...
    	[DataMember]
    	public Nullable<int> SubModuleActiveStatus { get; set; }
    ...
    public ERP_SubModule Clone(){
    	return this.MemberwiseClone() as ERP_SubModule;
    }
